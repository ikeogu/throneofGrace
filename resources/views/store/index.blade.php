				...
				<div class="row">
							<div class="col-md-3">
								<div class="list-group">
									...
									<a href="{{route('E-store.index')}}" class="list-group-item current"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Store <span class="badge">{{App\Book::count()}}</span>
									</a>
							...
							<div class="col-md-9">
								...
								<div class="panel panel-default">
												...
												<div class="panel-body">
																...
																<br>
																<table class="table table-strip table-hover tablemobile">
																				<tr>
																								<th>S/No</th>
																								<th>Title</th>
																								<th>Author</th>
